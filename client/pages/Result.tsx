...
//             {/* THE MAKER COMPONENT (It has its own height/canvas) */}
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className="h-[60vh] w-full relative bg-gradient-to-b from-stone-900 to-black border-b border-stone-800">
           <Suspense fallback={
              ...
              {/* We keep Canvas here because Artifact components are just 'Shapes' */}
              <Canvas shadows dpr={[1, 2]} camera={{ position: [0, 0, 8], fov: 45 }}>
        ...
        {activeMaker && (
          <div className="w-full border-t border-stone-800">
            ...
            {/* HEIGHT INCREASED TO 600px HERE */}
            <div className="h-[600px] w-full relative">
                {/* We do NOT wrap this in Canvas because the Maker Component HAS its own Canvas */}
                {activeMaker}
            </div>
          </div>
        )}
