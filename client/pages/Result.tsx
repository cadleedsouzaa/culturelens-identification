...
// --- FIX IMPORT PATH ---
// Based on your file tree, it is likely in 'ui' folder
import OralHistoryRecorder from '../components/OralHistoryRecorder'; 

const Result = () => {
  const { id } = useParams(); // This 'id' is already 'warli', 'channapatna', etc.
    ...
    <div className="h-screen bg-stone-950 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <div className="p-6 bg-stone-900 border-b border-stone-800">
          ...
          {/* --- UPDATE: PASS THE ID HERE --- */}
          {/* If ID is missing, default to 'general' */}
